...
* 📱 **[Mobile Floor Companion](https://yardstik-demo.vercel.app/mobile.html)** — Touch-optimized floor companion webapp hosted on Vercel Edge (*Auto-configured via `DEFAULT_SITE_ID: yardstik-demo`*).
